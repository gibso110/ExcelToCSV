    ...
    public class ExcelToCsvUI
    {
        ...
        public void ConvertExcel()
        {
            ...
            while (keepRunning)
            {
                ...
                else if (numberOfRows > 10000)
                {
                    ...
                    Over10kConvert(fileLocation, numberOfRows, directoryName, errorRow);
                    ConfirmationMessage();
                    keepRunning = false;
        ...
        public void Under10kConvert(string fileLocation, int numberOfRows, string directoryName, StreamWriter sw, int errorRow)
        {
            ...
            for (double i = 2; i < numberOfRowsUnder10k; i++)
            {
                ...
                HandleConversion(sw, excel, csv, errorWs, ws, i, errorRow);
        ...
        public void Over10kConvert(string fileLocation, int numberOfRows, string directoryName, int errorRow)
        {
            //Open correct worksheets and create an error spreadsheet
            ...
            for (double i = 10001; i < numberOfRows; i++)
            {
                ...
                HandleConversion(over10kSw, excel, csv, errorWs, ws, i, errorRow);
        ...
        public void HandleConversion(StreamWriter sw, Excel excel, Csv csv, Worksheet errorWs, Worksheet ws, double currentRow, int errorRow)
        {
            var rowOfData = ws.Rows[$"{currentRow}"];
